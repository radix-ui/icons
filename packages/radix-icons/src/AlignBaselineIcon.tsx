...
export const AlignBaselineIcon = ({
  ...
  if (type === 'outline' && size === '25') {
    return (
      <svg width="25" height="25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M20.5 13.5l-3 4-3-4" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
  ...
  console.error(`AlignBaselineIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};
