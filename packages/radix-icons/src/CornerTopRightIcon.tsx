...
interface CornerTopRightIconProps extends BaseIconProps {
  size?: '15';
  type?: 'normal';
}
...
export const CornerTopRightIcon = ({
  ...
  console.error(`CornerTopRightIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};
