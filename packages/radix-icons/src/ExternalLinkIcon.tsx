  ...
  if (type === 'outline' && size === '15') {
    return (
      <svg width="15" height="15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
          d="M12.8536 2.14645C12.9015 2.19439 12.9377 2.24964 12.9621 2.30861C12.9861 2.36669 12.9996 2.4303 13 2.497L13 2.5V2.50049V5.5C13 5.77614 12.7761 6 12.5 6C12.2239 6 12 5.77614 12 5.5V3.70711L6.85355 8.85355C6.65829 9.04882 6.34171 9.04882 6.14645 8.85355C5.95118 8.65829 5.95118 8.34171 6.14645 8.14645L11.2929 3H9.5C9.22386 3 9 2.77614 9 2.5C9 2.22386 9.22386 2 9.5 2H12.4999H12.5C12.5678 2 12.6324 2.01349 12.6914 2.03794C12.7504 2.06234 12.8056 2.09851 12.8536 2.14645ZM3 4C2.44772 4 2 4.44772 2 5V12C2 12.5523 2.44772 13 3 13H10C10.5523 13 11 12.5523 11 12V9.07143C11 8.79529 10.7761 8.57143 10.5 8.57143C10.2239 8.57143 10 8.79529 10 9.07143V12H3V5H5.92857C6.20471 5 6.42857 4.77614 6.42857 4.5C6.42857 4.22386 6.20471 4 5.92857 4H3Z"
          fill={color}
          fillRule="evenodd"
          clipRule="evenodd"
        />
