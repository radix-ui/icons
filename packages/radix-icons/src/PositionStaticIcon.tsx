    ...
    return (
      <svg width="25" height="25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path
          ...
          strokeLinecap="round"
        />
        <path d="M17.5 5.5h2v2" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }

  console.error(`PositionStaticIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};
