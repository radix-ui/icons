...
interface CornerBottomRightIconProps extends BaseIconProps {
  size?: '15';
  type?: 'outline';
}
...
export const CornerBottomRightIcon = ({
  ...
  console.error(`CornerBottomRightIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};
