  ...
  if (type === 'outline' && size === '25') {
    return (
      <svg width="25" height="25" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <path d="M12.5 9.5l-4 3 4 3" stroke={color} strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.5 12.5h8" stroke={color} strokeLinecap="round" />
      </svg>
    );
  }

  console.error(`ArrowLeftCircledIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};
