  ...
  if (type === 'outline' && size === '15') {
    return (
      <svg width="15" height="15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
          d="M4 2.9H12C12.0552 2.9 12.1 2.94477 12.1 3V12C12.1 12.0552 12.0552 12.1 12 12.1H4V2.9ZM2 3C2 2.44771 2.44772 2 3 2H12C12.5523 2 13 2.44772 13 3V12C13 12.5523 12.5523 13 12 13H3C2.44771 13 2 12.5523 2 12V3Z"
          fill={color}
          fillRule="evenodd"
          clipRule="evenodd"
        />
