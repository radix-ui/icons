...
interface ComponentMultiPartIconProps extends BaseIconProps {
  size?: '15';
  type?: 'outline';
}

export const ComponentMultiPartIcon = ({
  color = 'currentColor',
  size = '15',
  type = 'outline',
  ...props
}: ComponentMultiPartIconProps) => {
  ...
  console.error(`ComponentMultiPartIcon doesn't support the combination of ${size} and ${type}`);
  return null;
};

export default ComponentMultiPartIcon;
